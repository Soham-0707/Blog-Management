...
<div class="row justify-content-center">
    <div class="col-12 col-xl-8">
        <div class="page-hero mb-4 fade-in-up">
            <h1 class="h2 fw-bold mb-1">Create New Article</h1>
            <p class="text-muted-soft mb-0">Write and publish a new blog post with rich formatting and media support.</p>
        </div>
                ...
                <form method="POST" action="{{ route('admin.blogs.store') }}" enctype="multipart/form-data" class="row g-4">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="short_description" class="form-control @error('short_description') is-invalid @enderror" 
                                  rows="3" placeholder="Brief summary of your article" required>{{ old('short_description') }}</textarea>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" name="category" class="form-control @error('category') is-invalid @enderror" 
                               placeholder="e.g., Technology, Lifestyle" list="categories" value="{{ old('category') }}" required>
